export const EmployeeBirthDayEmailTemplate = (data, index) => {
  return `<!DOCTYPE HTML
        ...
        <tbody>
            <tr style="vertical-align: top">
                <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="https://www.tmrinfra.com/images/tmr-logo.svg"
                    ...
                    <div class="u-row-container" style="padding: 0px;background-color: transparent">
                        <div class="u-row"
                            style="margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #006151;">
                            <div
                                style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                                                            ...
                                                            <table role="presentation" width="100%" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="https://assets.unlayer.com/projects/273377/1746509520285-birthday-cake.png"
                                                                            alt="Image" title="Image"
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p
                                                                    ...
                                                                    <span
                                                                        style="font-size: 24px; line-height: 33.6px;"><strong>Birthday
                                                                            Remainder For Tomorrow</strong></span>
                                                                </p>
                                                            </div>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 31px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p
                                                                    style="font-size: 14px; line-height: 140%; margin: 0px;">
                                                                    <span
                                                                        style="font-size: 18px; line-height: 25.2px;">Just
                                                                        a friendly reminder about the employee
                                                                        celebrating their birthdays tomorrow</span>
                                                                </p>
                                                            </div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <table style="font-family:'Cabin',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:17px;font-family:'Cabin',sans-serif;"
                                                            align="left">

                                                            <div>
                                                                <table width="100%" cellpadding="0" cellspacing="0"
                                                                    style="max-width:700px; margin:auto; border-collapse:collapse; font-family:Segoe UI, Tahoma, Geneva, Verdana, sans-serif; background-color:#fff; box-shadow:0 2px 8px rgba(0,0,0,0.1); border-radius:8px; overflow:hidden;">
                                                                    <tbody>
                                                                        <tr>
                                                                            <th
                                                                                style="background-color:#006151; color:#fff; text-align:left; padding:12px 16px;">
                                                                                S. No.</th>
                                                                            <th
                                                                                style="background-color:#006151; color:#fff; text-align:left; padding:12px 16px;">
                                                                                Employee Name</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                style="font-size: 14px; color: #fafafa; letter-spacing: 4px; line-height: 180%; text-align: center; word-wrap: break-word;">
                                                                <p style="line-height: 180%; margin: 0px;">Tmr Group
                                                                    seeds of prosperity</p>
                                                            </div>
